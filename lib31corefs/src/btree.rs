...
impl BtreeNode {
        ...
        D: Write + Read + Seek,
    {
        ...
        for _ in 0..self.entries.len() / 2 {
            another.entries.insert(0, self.entries.pop().unwrap());
        }
        ...
        Ok((another.entries.first().unwrap().key, another.block_count))
    }
